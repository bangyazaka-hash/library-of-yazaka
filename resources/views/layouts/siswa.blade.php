...
<head>
    ...
    <title>@yield('title', 'Siswa Panel - Library')</title>
    ...
    <aside id="sidebar"
        ...
        <div class="flex items-center justify-between px-6 py-6 border-b" style="border-color: #f0e8dc;">
            <div>
                ...
                <p class="text-sm mt-1" style="color: #7b8a97;">Siswa Panel</p>
            </div>
        ...
        <nav class="p-5 space-y-3">
            ...
            <a href="{{ route('siswa.dashboard') }}"
               ...
               style="background-color: {{ request()->routeIs('siswa.dashboard') ? '#F4A261' : '#FDFBF7' }};
                      color: {{ request()->routeIs('siswa.dashboard') ? 'white' : '#34495E' }};">
                Dashboard
            </a>

            <a href="{{ route('siswa.buku.index') }}"
               class="block px-4 py-3 rounded-2xl font-medium"
               style="background-color: {{ request()->routeIs('siswa.buku.*') ? '#F4A261' : '#FDFBF7' }};
                      color: {{ request()->routeIs('siswa.buku.*') ? 'white' : '#34495E' }};">
                Pinjam Buku
            </a>

            <a href="{{ route('siswa.peminjaman.index') }}"
               class="block px-4 py-3 rounded-2xl font-medium"
               style="background-color: {{ request()->routeIs('siswa.peminjaman.*') ? '#F4A261' : '#FDFBF7' }};
                      color: {{ request()->routeIs('siswa.peminjaman.*') ? 'white' : '#34495E' }};">
                Riwayat Peminjaman
            </a>

            <a href="{{ route('siswa.pengembalian.index') }}"
               class="block px-4 py-3 rounded-2xl font-medium"
               style="background-color: {{ request()->routeIs('siswa.pengembalian.*') ? '#F4A261' : '#FDFBF7' }};
                      color: {{ request()->routeIs('siswa.pengembalian.*') ? 'white' : '#34495E' }};">
